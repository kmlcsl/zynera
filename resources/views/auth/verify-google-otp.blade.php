...
<head>
    ...
    <title>Verifikasi OTP - {{ config('app.name', 'Zynera') }}</title>
            ...
            <div class="relative z-10 flex flex-col justify-center p-12 text-white">
                ...
                <div class="max-w-md">
                    ...
                    <p class="text-emerald-100 text-lg leading-relaxed mb-8">
                        ...
                        Langkah terakhir untuk bergabung dengan komunitas Zynera.
                    </p>
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div class="text-center">
                    <div class="flex justify-center mb-6">
                        <div
                            class="w-16 h-16 Zynera-primary rounded-2xl flex items-center justify-center shadow-lg">
                    ...
                    <p class="text-Zynera-primary font-medium mt-1">{{ $email }}</p>
            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-6 shadow-xl rounded-2xl border border-slate-200">
                    ...
                    <form method="POST" action="{{ route('google.otp.verify.post') }}" class="space-y-6">
                        ...
                        <!-- Submit Button -->
                        <div>
                            <button type="button" x-on:click="submitOtpForm()"
                                class="w-full flex justify-center items-center py-4 px-4 border border-transparent rounded-xl shadow-lg text-sm font-medium text-white Zynera-primary hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-200 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    ...
                    <div class="mt-6 text-center">
                        <div x-show="!isResendDisabled" x-transition>
                            <form method="POST" action="{{ route('google.otp.resend') }}" style="display: inline;">
                                ...
                                <input type="hidden" name="email" value="{{ $email }}">
                                <button type="submit"
                                    class="inline-flex items-center text-Zynera-primary hover:underline font-medium text-sm transition-colors duration-200">
                ...
                <div class="mt-8 text-center space-y-2">
                    <p class="text-sm text-slate-600">
                        <a href="{{ route('register') }}"
                            class="font-medium text-Zynera-primary hover:underline">
        ...
        function otpVerification() {
            return {
                ...
                init() {
                    ...
                    this.refreshCsrfToken(); // Refresh CSRF token saat init
                ...
                // Submit OTP with retry logic for 419 errors
                async submitOtpForm() {
                    ...
                    try {
                        ...
                        if (response.status === 419) {
                            ...
                            console.log('CSRF expired, refreshing token and retrying...');
                            await this.refreshCsrfTokenImmediate();
                            
                            // Update form token and retry
                            const newFormData = new FormData(form);
                            newFormData.set('_token', this.csrfToken);
                            ...
                            if (retryResponse.ok) {
                                window.location.href = retryResponse.url || '{{ route("home") }}';
                            } else {
                        ...
                        // Fallback: use regular form submit
                        form.submit();
                    }
                },

                // Immediate CSRF refresh
                async refreshCsrfTokenImmediate() {
                    try {
                        ...
                        console.error('CSRF immediate refresh failed:', error);
                    }
                },
