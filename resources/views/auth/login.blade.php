...
<head>
    ...
    <title>Masuk - {{ config('app.name', 'Zynera') }}</title>
            ...
            <div class="relative z-10 flex flex-col justify-center p-12 text-white">
                ...
                <div class="max-w-md">
                    ...
                    <p class="text-emerald-100 text-lg leading-relaxed mb-8">
                        Masuk ke akun Anda dan lanjutkan bertransaksi minyak jelantah berkualitas
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-emerald-100">Minyak jelantah kualitas terjamin</span>
                        </div>
                        <div class="flex items-center">
                            <div
                                class="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-3">
                            ...
                            <span class="text-emerald-100">Sistem grading A, B, dan raw material</span>
                        </div>
                        <div class="flex items-center">
                            <div
                                class="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-3">
                            ...
                            <span class="text-emerald-100">Kontrol kualitas dan filterasi ketat</span>
                        </div>
                        <div class="flex items-center">
                            <div
                                class="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-3">
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-slate-600">
                        Atau
                        <a href="{{ route('register') }}" class="font-medium text-zynera-primary hover:underline">
