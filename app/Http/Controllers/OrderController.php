...
class OrderController extends Controller
{
    ...
    /**
     * Helper method to check if user can view order - FIXED TYPE COMPARISON
     */
    ...
    public function getDeliveryStatus(Order $order)
    {
        ...
        return response()->json([
            ...
            'status_label' => $delivery ? $delivery->status_label : null,
            'updated_at' => $delivery ? $delivery->updated_at : null
        ]);
    }
}
